...
assert.equal(manifest.name, 'MightyCringe');
assert.equal(manifest.short_name, 'MightyCringe');
assert.equal(manifest.theme_color, '#f4e8cf');
assert.equal(manifest.background_color, '#f4e8cf');
