...
Сейчас нет активных задач разработки. Выпущенные изменения находятся в [DONE.md](./DONE.md),
оставшиеся проверки и настройки внешних сервисов — в разделе «Ждёт владельца» ниже.
...
1. **Включить поиск неизвестных упражнений в production после merge.**
   Локальная проверка владельцем пройдена. После merge внести уже созданные `OPENROUTER_API_KEY` и
   `EXERCISE_DISCOVERY_MODEL` в защищённый production environment, выполнить deploy и двумя
   аккаунтами подтвердить сохранение и изоляцию персональных упражнений. Инструкция:
